...
export async function handler(event, context) {
  try {
    ...
    const SENDGRID_API_KEY = process.env.NETLIFY_CONTACT_FORM;
    ...
    const msg = {
      ...
      from: "ahbee2963@gmail.com",     // must be a verified sender in SendGrid
      replyTo: data.user_email,        // visitor's email
